...
import { FileCode, Search, Coins, KeyRound } from "lucide-react";
import Link from "next/link";
import { howItWorksConfig } from "@/lib/config";
import type { ReactNode } from "react";

const stepIcons = [FileCode, Search, Coins, KeyRound];

const steps = howItWorksConfig.steps.map((s, i) => ({
  ...s,
  icon: stepIcons[i] ?? FileCode,
}));
