...
|------|---------|------------|
| `public/BG.jpg` | Hero background | 1920x1080+ |
| `public/dashboardmock.png` | Product screenshot | 1920x1080 |
| `public/mock-logos/*.svg` | Company logos | ~120x40 |
| `app/icon.svg` | Favicon | 32x32 |
| `app/apple-icon.svg` | Apple touch icon | 180x180 |

### Step 4: Toggle Features

In `lib/config.ts`, enable/disable features such as smooth scroll, testimonial autoplay, parallax hero, and blur-in headline.
...
The template is Edge-compatible and works with Vercel, Netlify, Cloudflare Pages, and any static hosting.
